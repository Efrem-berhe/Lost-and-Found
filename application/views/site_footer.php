...
<script src="<?=base_url()?>assets/js/secretQuestion.js" type="text/javascript"></script>
<script src="<?=base_url()?>assets/js/deleteItemAlert.js" type="text/javascript"></script>
<script src="<?=base_url()?>assets/js/alert.js" type="text/javascript"></script>
